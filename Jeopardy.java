...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == zeroButton) {
			...
			askQuestion("Who was the first to find that our solar system is acutally heliocentric?", "Copernicus", 600);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		if (input.equals(correctAnswer)) {
			...
			JOptionPane.showMessageDialog(null, "Correct. I guess you studied a little bit, but it won't be enough for the next question! Muwahhahah!(werid :P)");
		// Otherwise
		}else {
			// Decrement the score by the prizeMoney
			score -= prizeMoney;
			// Pop up a message to tell the user the correct answer
			JOptionPane.showMessageDialog(null, "Dummy! You didn't study hard. I knew it! The correct answer is " + correctAnswer + ", like it wasn't obvious... 0_0");
			// Call the updateScore() method
			updateScore();
		}
